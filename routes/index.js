...
router.get('/', function (req, res) {
  res.render('index', { title: 'Microphone App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Microphone App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', {title: 'Microphone App Login', user : req.user});
});
